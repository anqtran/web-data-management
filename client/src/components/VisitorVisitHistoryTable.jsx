...
const VisitorVisitHistoryTable = ({
  // onViewProperty,
  onSelectedRowDashboard,
...
VisitorVisitHistoryTable.propTypes = {
  // onViewProperty: PropTypes.func.isRequired,
  onSelectedRowDashboard: PropTypes.func,
  selectRowDashBoard: PropTypes.func,
  // onSubmit: PropTypes.func.isRequired,
  // onChange: PropTypes.func.isRequired,
  errors: PropTypes.object.isRequired,
  data: PropTypes.array.isRequired
...
export default VisitorVisitHistoryTable;
